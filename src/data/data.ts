...
export type SubjectDetail = {
  code: string;
  name: string;
  full_marks: number; // Changed to number
  pass_marks: number; // Changed to number
  total_credits: number; // Changed to number
  theory_credit: number; // Changed to number
  internal_credit: number; // Changed to number
};

export type SubjectDetails = SubjectDetail[];
export type Grades = (typeof GRADES)[number];

/**
 * Optional Subjects for grade 11
 */
export const GRADE_11_SUBJECTS_OPTIONAL: SubjectDetails = [
  {
    code: "1031",
    name: "Accounting",
    full_marks: 75,
 ...
 */
export const GRADE_11_SUBJECTS_COMPULSORY: SubjectDetails = [
  {
    code: "0031",
    name: "Com.English",
    full_marks: 75,
 ...
 */
export const GRADE_12_SUBJECTS_OPTIONAL: SubjectDetails = [
  {
    code: "1041",
    name: "Accounting",
    full_marks: 75,
 ...
 */
export const GRADE_12_SUBJECTS_COMPULSORY: SubjectDetails = [
  {
    code: "0041",
    name: "Com.English",
    full_marks: 75,
 ...
 * NG : undefined (interpreted as 0 here)
 * D  : 1.6
 * C  : 2.0
 * C+ : 2.4
 * B  : 2.8
 ...
 * A+ : 4.0
 */
export const GRADES = ["Please select", "NG", "D", "D+", "C", "C+", "B", "B+", "A", "A+"] as const;

/**
 * Array of Grades along with Grade Points.
 */
const gradePointMap: Record<string, number> = {
  ...
  "D": 1.2,
  "NG": 0.0,
  "Please select": 0.0, // Should not be used in calculation due to filtering
};

export const GRADES_DATA = GRADES.map(grade => ({
  grade: grade,
  gradePoint: gradePointMap[grade] !== undefined ? gradePointMap[grade] : 0, // Default to 0 if somehow not in map
}));

/**
 * Export subject data in an object for easy access.
 */
export const SUBJECT_DATA = {
  11: {
    compulsory: GRADE_11_SUBJECTS_COMPULSORY,
    optional: GRADE_11_SUBJECTS_OPTIONAL,
  },
  12: {
    compulsory: GRADE_12_SUBJECTS_COMPULSORY,
    optional: GRADE_12_SUBJECTS_OPTIONAL,
  },
};

/**
 * Presets for different streams
 */
